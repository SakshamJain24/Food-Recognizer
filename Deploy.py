...
""")
st.title("CuisineDetective - Uncover Food Types and Recipes")
# file = st.file_uploader("Please upload an food image", type=['jpeg', 'jpg', 'bmp', 'png'])
...
image = Image.open("C:\\Users\\saksh\\OneDrive\\Documents\\SML_EndSemProject\\paneer_butter_masala\\1.jpg")  # Replace "example_image.jpg" with the path to your image file
...
# Define the class names and corresponding recipes
class_names = ['Briyani', 'Dhokla', 'Dosa', 'Gulab_Jamun', 'Idli', 'Palak_Panner', 'ButterPaneerMasala', 'Poha',
               'Vada', 'Samosa', 'Vada Pav']
...
food_types = ["Poha", "Biryani", "Veg Biryani", "Dhokla", "Dosa", "Gulab Jamun", "Samosa", "Idli", "Palak Paneer", "Butter Paneer Masala", "Vada", "Vada Pav"]

# Create a Streamlit app
st.title("Available Food Types")

# Loop through the food types and print them as options
